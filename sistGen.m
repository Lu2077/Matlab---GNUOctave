...
if rank(A) == size(A, 2)
    ...
    title('¡Los vectores son linealmente independientes! Forman una BASE.');
    ...
    title('Los vectores son dependientes. No son una base, el subespacio tiene menor dimensión.');
